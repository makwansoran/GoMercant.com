    ...
    <div className={cn("flex flex-col gap-6", className)} {...props}>
      <Card className="overflow-hidden">
        <CardContent className="grid p-0 md:grid-cols-2">
          <div className="flex flex-col items-center justify-center p-6 md:p-8">
            <div className="flex flex-col gap-6 w-full max-w-sm">
              ...
              <div className="grid grid-cols-3 gap-2">
                <Button variant="outline" className="w-full aspect-square p-0" onClick={handleSkipAuth} title="Continue with Apple">
                ...
                <Button variant="outline" className="w-full aspect-square p-0" onClick={handleSkipAuth} title="Continue with Google">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                    <path
                ...
                <Button variant="outline" className="w-full aspect-square p-0" onClick={handleSkipAuth} title="Continue with Meta">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" className="h-5 w-5">
                    <path
          ...
          <div className="relative hidden md:block min-h-[400px] bg-muted">
