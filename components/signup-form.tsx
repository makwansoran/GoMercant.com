...
import { signup, setAuth, verifyCode, resendVerification } from "@/lib/auth"
...
export function SignupForm({
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if ('error' in result) {
      ...
      // If requires verification, show code input
    ...
    // If email is already verified (shouldn't happen on signup, but handle it)
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-6 md:p-8">
            <div className="flex flex-col gap-6">
              ...
              <Button onClick={handleVerifyCode} className="w-full" disabled={verifying}>
